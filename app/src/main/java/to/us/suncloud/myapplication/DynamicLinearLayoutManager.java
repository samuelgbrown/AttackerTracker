...
// Written by hidaron on GitHub, because I coded myself into a corner by being lazy
// https://gist.github.com/hidaron/7f1cbeea9a52ed548adb
public class DynamicLinearLayoutManager extends LinearLayoutManager {
    ...
    private void measureScrapChild(RecyclerView.Recycler recycler, int position, int widthSpec,
        ...
        try {
            ...
            Log.w("LayoutManager", "No views in recycler view yet...");
        }
    }
}